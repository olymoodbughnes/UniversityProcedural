...
public class AltLiftSawSpawner : MonoBehaviour
{
    //PUBLIC=========================================================================
    //Saws 
    ...
    public void spawnSaw()
    {
        ...
        if (randDisplacement == 2)
        {

            Instantiate(spinSaw, transform.position + SawPos[randDisplacement], Quaternion.Euler(0, 0, 270));

        }
        else if (randDisplacement == 0 || randDisplacement == 1)
        {
            Instantiate(spinSaw, transform.position + SawPos[randDisplacement], Quaternion.Euler(0, 0, 90));
        }
