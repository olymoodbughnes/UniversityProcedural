...
public class AltLBSawSpawner : MonoBehaviour
{
    //PUBLIC=========================================================================
    //Saws 
    ...
    public void spawnSaw()
    {
        ...
        if (randDisplacement == 0 || randDisplacement == 1)
        {

            Instantiate(spinSaw, transform.position + SawPos[randDisplacement], Quaternion.Euler(0, 0, 180));

        }
        else if  (randDisplacement == 2)
        {
