...
public class CoinSpawnPointSpawned : MonoBehaviour
{
    ...
    {
        //Coin Positions
        CoinPos = new Vector3[] {new Vector3(3, -0.5f), new Vector3(3, 2.5f), new Vector3(7, 0.57f), new Vector3(7, -2.5f), new Vector3(5, 0)};
